...
class NativeRealCollPaginator extends StatefulWidget {
  /// --------------------------------------------------------------------------
  const NativeRealCollPaginator({
  ...
  /// --------------------------------------------------------------------------
  @override
  _NativeRealCollPaginatorState createState() => _NativeRealCollPaginatorState();
  /// --------------------------------------------------------------------------
}

class _NativeRealCollPaginatorState extends State<NativeRealCollPaginator> {
  // -----------------------------------------------------------------------------
  ...
  // --------------------
  @override
  void didUpdateWidget(covariant NativeRealCollPaginator oldWidget) {
  ...
  Future<void> _readMore() async {
    ...
    if (_paginatorController.canKeepReading.value  == true){
      ...
      final List<Map<String, dynamic>> _nextMaps = await NativeReal.readPathMaps(
