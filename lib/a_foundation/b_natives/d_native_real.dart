...
abstract class NativeReal {
  ...
  static Future<void> _purge() async {
    await NativeFirebase.getReal()?.purgeOutstandingWrites();
  }
  // -----------------------------------------------------------------------------
  static Future<void> goOnline() async {
    await NativeFirebase.getReal()?.goOnline();
  }
  // --------------------
  static Future<void> goOffline() async {
    await NativeFirebase.getReal()?.goOffline();
  }
  // -----------------------------------------------------------------------------
