...
class NativeFirebase {
  ...
  static Future<void> initialize({
    ...
    /// AUTH FIRE
    final fd.FirebaseAuth _auth = await NativeFirebase.instance._initializeAuthFire(
    ...
    /// AUTH REAL
    NativeFirebase.instance._initializeAuthReal(
        app: _app,
    );
  ...
  static fd.FirebaseAuth? getAuthFire() => NativeFirebase.instance.authFire;
  // --------------------
  /// TESTED : WORKS PERFECT
  ...
  static f_d.FirebaseAuth? getAuthReal() => NativeFirebase.instance.authReal;
  // --------------------
  /// TESTED : WORKS PERFECT
