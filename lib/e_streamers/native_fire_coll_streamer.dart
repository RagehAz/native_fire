...
class NativeFireCollStreamer extends StatefulWidget {
  // --------------------------------------------------------------------------
  const NativeFireCollStreamer({
  ...
  // --------------------------------------------------------------------------
  @override
  State<NativeFireCollStreamer> createState() => _NativeFireCollStreamerState();
  // --------------------------------------------------------------------------
}

class _NativeFireCollStreamerState extends State<NativeFireCollStreamer> {
  // -----------------------------------------------------------------------------
  ...
  void initState() {
    ...
    _stream = NativeFire.streamColl(
      queryModel: widget.queryModel,
    );

    _sub = NativeFireCollStreamer.initializeStreamListener(
      stream: _stream,
      mounted: mounted,
      oldMaps: _oldMaps,
