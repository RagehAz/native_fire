...
class NativeFireDocStreamer extends StatefulWidget {
  // --------------------------------------------------------------------------
  const NativeFireDocStreamer({
  ...
  // --------------------------------------------------------------------------
  @override
  _NativeFireDocStreamerState createState() => _NativeFireDocStreamerState();
  // --------------------------------------------------------------------------
}

class _NativeFireDocStreamerState extends State<NativeFireDocStreamer> {
  // -----------------------------------------------------------------------------
  ...
  void initState() {
    ...
    _stream = NativeFire.streamDoc(
      coll: widget.collName,
      doc: widget.docName,
    );

    _sub = NativeFireDocStreamer.initializeStreamListener(
      stream: _stream,
      oldMap: _oldMap,
      mounted: mounted,
